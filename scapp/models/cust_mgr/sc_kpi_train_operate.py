...
class SC_Kpi_Train_Operate(db.Model):
	...
	def __init__(self,job_tendency,index,assess_date,marketing_plain,
		marketing_complete,marketing_score,sign_plain,sign_complete,sign_score,loan_balance_plain,loan_balance_complete,
		loan_balance_score,monitor_plain,monitor_complete,monitor_score,ywdlx,yxnl,dqdc,sdhcs,jszs,khfw,kqjl,
