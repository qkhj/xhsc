...
import daily_work, monthly_work
...
class timing():
    def __init__(self):
        ...
        sched.add_cron_job(monthly_work.run(),month='1-12',day='1',hour='3') #银行每月客户经理有效管户更新
        sched.add_cron_job(daily_work.data_convert, month='1-12', day='1-30', hour='4')#银行每日还款数据更新
