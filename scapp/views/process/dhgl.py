...
def Process_dhgl():
    ...
    return render_template("Process/dhgl/dhgl_search.html",loan_product=loan_product)
...
def dhgl_search(page):
    ...
    return render_template("Process/dhgl/dhgl.html",loan_apply=loan_apply,customer_name=customer_name,loan_type=loan_type,loan_product=loan_product)
