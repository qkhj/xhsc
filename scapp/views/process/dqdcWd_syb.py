...
# 贷款调查——小额贷款(损益情况分析)
@app.route('/Process/dqdc/dqdcWd_syb/<int:loan_apply_id>', methods=['GET','POST'])
def dqdcWd_syb(loan_apply_id):
	if request.method == 'GET':
		...
		return render_template("Process/dqdc/dqdcWd_syb.html",loan_apply_id=loan_apply_id,profit_loss=profit_loss,
