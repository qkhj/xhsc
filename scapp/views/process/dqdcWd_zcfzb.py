...
# 贷款调查——微贷(资产负债表)
@app.route('/Process/dqdc/dqdcWd_zcfzb/<int:loan_apply_id>', methods=['GET','POST'])
def dqdcWd_zcfzb(loan_apply_id):
	if request.method == 'GET':
		...
		return render_template("Process/dqdc/dqdcWd_zcfzb.html",loan_apply_id=loan_apply_id,
