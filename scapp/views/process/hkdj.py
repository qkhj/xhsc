...
def Process_hkdj():
	...
	return render_template("Process/hkdj/hkdj_search.html",user=user,role=role)
...
def hkdj_search(page):
	...
	return render_template("Process/hkdj/hkdj.html",loan_apply=loan_apply,customer_name=customer_name,
		loan_type=loan_type,manager=manager,user=user)
...
def edit_hkdj(loan_apply_id):
	...
	return render_template("Process/hkdj/edit_hkdj.html",loan_apply=loan_apply,loan_repayment=loan_repayment)